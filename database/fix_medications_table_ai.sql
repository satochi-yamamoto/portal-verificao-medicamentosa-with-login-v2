-- ========================================
-- CORREÇÃO: ATUALIZAÇÃO DA TABELA MEDICATIONS COM DADOS DA IA
-- Execute este SQL no Supabase Dashboard > SQL Editor
-- ========================================

-- PRIMEIRO: Remover função existente que está conflitando
DROP FUNCTION IF EXISTS get_medication_capture_stats();
...
-- NOVA FUNÇÃO para obter estatísticas de medicamentos capturados (com campo adicional)
